...
def infer_img(cfg, metric_net, dataset, bbox_scale='S'):
...
def get_pred_img():
    ...
    img_set_part1 = get_img_dicts('/tcdata/test_dataset_3w/test_dataset_part1/image')
    img_set_part2 = get_img_dicts('/tcdata/test_dataset_3w/test_dataset_part2/image')
